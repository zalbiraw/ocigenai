...
// Package ocisdk provides supporting functions and structs used by service packages
package ocisdk
...
func defaultUserAgent() string {
	userAgent := fmt.Sprintf(defaultUserAgentTemplate, defaultSDKMarker, runtime.GOOS, runtime.GOARCH, "", runtime.Version())
